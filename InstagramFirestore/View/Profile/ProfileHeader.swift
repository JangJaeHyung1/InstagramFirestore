...
protocol ProfileHeaderDelegate: class {
    func header(_ profileHeadr: ProfileHeader, didTapActionButtonFor user: User)
}
...
//        iv.image = #imageLiteral(resourceName: "venom-7")
    ...
    private lazy var editProfileFollowButton: UIButton = {
        ...
        button.setTitle("장재형 프로필", for: .normal)
    ...
    private lazy var postsLabel: UILabel = {
        ...
        label.attributedText = attributedStatText(value: 5, label: "게시글")
        return label
    }()
...
//        print("DEBUG: tapped edit profile button")
    ...
    func configure() {
//        print("DEBUG: Confiugre header user info")
        guard let viewModel = viewModel else { return }
