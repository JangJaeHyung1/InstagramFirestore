...
class LoginController: UIViewController {
    ...
    private let forgotPasswordButton: UIButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string: "비밀번호를 잊어버리셨습니까?", attributes: atts)
        
        let boldAtts: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor(white: 1, alpha: 0.7), .font: UIFont.boldSystemFont(ofSize: 16)]
        attributedTitle.append(NSAttributedString(string: "", attributes: boldAtts))
    ...
    private let signUpButton: UIButton = {
        ...
        let atts: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor(white: 1, alpha: 0.7), .font: UIFont.systemFont(ofSize: 16)]
        let attributedTitle = NSMutableAttributedString(string: "계정이 없으시다면..    ", attributes: atts)
        
        let boldAtts: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor(white: 1, alpha: 0.7), .font: UIFont.boldSystemFont(ofSize: 16)]
        attributedTitle.append(NSAttributedString(string: "회원가입하기", attributes: boldAtts))
